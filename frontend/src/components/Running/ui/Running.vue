...
<template>
    <div class="py-[20px] flex flex-col gap-3 items-start">
        <button class="bg-[#29A851] h-[40px] w-[240px] text-white rounded-[15px]">ВКЛЮЧИТЬ СИМУЛЯЦИЮ</button>
                ...
                <div class="flex bg-[#f1f1f1] rounded-[10px] w-full p-2">
                    <div class="text-[16px] flex flex-col gap-[30px] w-fit min-w-[120px]">
                        <div>
                            ...
                            <a-divider style="height: 1px; ; background-color: black; margin-block: 2px"></a-divider>
                        </div>
                        <div>
                    ...
                    <div class="w-full h-full flex flex-col gap-[30px]">
                        <div  
                            class="runner h-[28px] bg-red-500" 
                            :style="{ width: String(runners_data.runner_one) + '%'}"
                            >
                        </div>

                        <div  
                            class="runner h-[28px] bg-pink-400" 
                            :style="{ width: String(runners_data.runner_two) + '%'}"
                            >
                        </div>

                        <div  
                            class="runner h-[28px] bg-blue-400" 
                            :style="{ width: String(runners_data.runner_three) + '%'}"
                            >
                        </div>

                        <div  
                            class="runner h-[28px] bg-orange-400" 
                            :style="{ width: String(runners_data.runner_four) + '%'}"
                            >
                        </div>

                        <div  
                            class="runner h-[28px] bg-green-400" 
                            :style="{ width: String(runners_data.runner_five) + '%'}"
                            >
                        </div>

                        <div  
                            class="runner h-[28px] bg-blue-700" 
